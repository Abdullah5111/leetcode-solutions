...
Each file is named `<4-digit-problem-number>_<snake_case_title>.py` and contains a self-contained solution: problem statement, approach, time/space complexity in the docstring, and a quick `if __name__ == "__main__"` smoke test at the bottom.
...
| 509 | Fibonacci Number | Easy | [0509_fibonacci_number.py](./0509_fibonacci_number.py) |
| 535 | Encode and Decode TinyURL | Medium | [0535_encode_and_decode_tinyurl.py](./0535_encode_and_decode_tinyurl.py) |
...
| 3783 | Mirror Distance of an Integer | Easy | [3783_mirror_distance_of_an_integer.py](./3783_mirror_distance_of_an_integer.py) |
